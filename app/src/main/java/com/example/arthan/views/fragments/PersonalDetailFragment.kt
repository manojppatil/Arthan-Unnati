...
class PersonalDetailFragment : BaseFragment() {
    ...
    fun updateData(
        ...
        if (personalDetailsList != null) {
            for(i in personalDetailsList.indices) {
                when (personalDetailsList[i].applicantType) {
                    "PA" -> {
                        var personalDetails = personalDetailsList?.get(i)
                    ...
                    "CA" -> {
                        CAView.visibility = View.VISIBLE
                        var personalDetails = personalDetailsList?.get(i)
